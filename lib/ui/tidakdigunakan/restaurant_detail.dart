...
import 'package:filmax/data/model/tidakdigunakan/detail_restaurant.dart'
    as restaurant;
import 'package:filmax/provider/database_provider.dart';
import 'package:filmax/provider/tidakdigunakan/detail_restaurant_provider.dart';
            ...
            body: SingleChildScrollView(
              child: Column(
                children: [
                  Hero(
                    tag: state.result!.id,
                    child: Image.network(ApiService.baseUrlImage +
                        "medium/" +
                              ...
                              Flexible(
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Text("- " +
                                        state.result!.menus.foods[index].name);
                                  },
                                ),
                              ),
                            ],
                            ...
                            children: [
                              Flexible(
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Text("- " +
                                        state.result!.menus.drinks[index].name);
                                  },
                                ),
                              ),
                            ],
                            ...
                            children: [
                              Flexible(
                                child: ListView.builder(
                                  ...
                                  itemCount:
                                      state.result!.customerReviews.length,
                                  itemBuilder: (context, index) {
                                    return Card(
                                      elevation: 1.7,
                                      child: Row(
                  ...
                  onPressed: () {
                    isFavorite
                        ...
                        : provider.addFavorite(
                            DataMapper().restaurantDetailToFavorite(state));
                  },
                );
              },
            );
